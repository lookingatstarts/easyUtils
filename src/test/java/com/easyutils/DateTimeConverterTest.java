...
import com.easyutils.time.Formats;
import com.easyutils.time.Zones;
...
public class DateTimeConverterTest {
  ...
  @Test
  public void test() {
    String format = Formats.YEAR_MONTH_DAY_TIME_FORMATTER;
    ZoneId defaultZoneId = Zones.DEFAULT_ZONE_ID;
    ZoneId americaNewYork = Zones.AMERICA_NEW_YORK;
    ZoneId utcMinus5 = Zones.GMT_MINUS_5;
